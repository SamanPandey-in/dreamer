-- CreateEnum
CREATE TYPE "DeploymentStatus" AS ENUM ('QUEUED', 'LAUNCHING', 'BUILDING', 'UPLOADING', 'STARTING', 'RUNNING', 'SLEEPING', 'WAKING', 'STOPPED', 'FAILED', 'CANCELLED', 'ERROR');
...
CREATE TABLE "Deployment" (
    ...
    "deployedById" UUID,
    "url" TEXT,
    "buildContainerId" TEXT,
    "imageUri" TEXT,
    "appContainerId" TEXT,
    "appContainerName" TEXT,
    "appUrl" TEXT,
    "outputPrefix" TEXT,
    "errorMessage" TEXT,
...
CREATE TABLE "DeploymentLog" (
    ...
    "ts_message" tsvector DEFAULT to_tsvector('english'::regconfig, message),
