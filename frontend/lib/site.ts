// Single source of truth for the site origin — every piece of SEO metadata
// (layout.tsx, sitemap.ts, robots.ts, opengraph-image.tsx, twitter-image.tsx)
// derives from here instead of hardcoding the domain separately.
//
...
// since this is a self-hosted build anyone can run under their own domain.
export const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "http://localhost:3000";
export const SITE_NAME = "Dreamer";

export const SITE_TAGLINE = "Your own Vercel — deployed in seconds, owned forever";

// Reused verbatim in metadata descriptions, the OG/Twitter image, and
// llms.txt — deliberately short and factual so it's the one sentence every
// surface (search results, link unfurls, AI answer engines alike) agrees on.
