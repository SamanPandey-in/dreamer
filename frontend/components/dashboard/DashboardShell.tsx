...
export function DashboardShell({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    document.documentElement.classList.add("authenticated-scrollbar");
    document.body.classList.add("authenticated-scrollbar");

    return () => {
      document.documentElement.classList.remove("authenticated-scrollbar");
      document.body.classList.remove("authenticated-scrollbar");
    };
  }, []);
