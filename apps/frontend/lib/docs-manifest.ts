...
export const docsManifest: DocEntry[] = [
  ...
  { slug: "self-hosting", source: "SELF-HOSTING.md", title: "Self-Hosting Guide", group: "Guides" },
  { slug: "aws-setup", source: "AWS-Console-Setup-Guide.md", title: "AWS Console Setup Guide", group: "Guides" },
];
