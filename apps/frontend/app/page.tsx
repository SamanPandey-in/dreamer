...
// Custom Github Icon SVG since it is not exported in this lucide-react version
...
// Dynamically import GodRays to prevent SSR/hydration issues
...
export default function Home() {
  ...
  // Auto-scroll terminal simulator
  useEffect(() => {
  ...
  // Handle mock deployment simulator
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 font-sans selection:bg-blue-500/30 selection:text-blue-200">
          ...
          {mobileMenuOpen && (
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                ...
                <button className="w-full py-2.5 rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 font-medium text-white shadow-lg shadow-blue-500/20">
                  Launch Console
                </button>
              </div>
            </motion.div>
      ...
      <section className="relative min-h-[90vh] md:min-h-screen flex items-center justify-center pt-24 overflow-hidden bg-black">
        {/* God Rays WebGL Shader background */}
        ...
        {/* Ambient Dark Gradient Fade to blend shader with rest of page */}
